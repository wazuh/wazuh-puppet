...
class wazuh::agent (
  ...
  $ossec_config_ubuntu_profiles,
  $ossec_config_centos_profiles,
  $ossec_notify_time,
  ...
  $sca_windows_enabled,
  $sca_windows_scan_on_start,
  $sca_windows_interval,
  $sca_windows_skip_nfs,
  ...
  $ossec_syscheck_windows_audit_interval,
  ...
  $ossec_active_response_linux_ca_store,

  $ossec_active_response_ca_verification,
