...
STAGE=""
FILES_EDITED=()
FILES_EXCLUDED='--exclude="repository_bumper_*.log" --exclude="CHANGELOG.md" --exclude="metadata.json" --exclude="repository_bumper.sh" --exclude="Puppetfile" --exclude=".travis.yml" --exclude="Gemfile" --exclude="4_bumper_repository.sh"'
